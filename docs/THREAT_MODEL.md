# bank-customer-churn-prediction: STRIDE Threat Model & Security Posture

Security analysis for **Enterprise Bank Customer Churn Prediction & Retention Optimizer**.
