# bank-customer-churn-prediction: Production Operations Runbook & Incident Triage

Production guidance, operational SLOs, and incident playbooks for **Enterprise Bank Customer Churn Prediction & Retention Optimizer**.
