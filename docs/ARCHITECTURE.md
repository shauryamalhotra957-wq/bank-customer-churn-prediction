# bank-customer-churn-prediction: System Architecture & Technical Topology

Scikit-learn and XGBoost churn classification pipeline with probability calibration, ROC-AUC metrics, and Dice score calculation.
...
flowchart TD
    ...
    subgraph CoreEngine["Core Computational Engine"]
        ...
        ModelCore["Inference / Decision Pipeline (Enterprise Bank Customer Churn Prediction & Retention Optimizer)"]
...
sequenceDiagram
    ...
    participant Engine as bank-customer-churn-prediction Core
